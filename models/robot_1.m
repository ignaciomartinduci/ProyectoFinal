    ...
    d_5 = 0.100;
    d_6 = 0;
    TCP = 0.245 ;%0.245; % ajustar% 0.15 a 0.245
    ...
    R.plot3d(q_0, ...
    'path', 'C:\Users\Usuario\Desktop\FING\Proyecto Final\matlab\models\CAD','alpha',0.25); 
    axis equal
    axis manual
    hold on
    trplot(R.A(1:5, q_0).T, 'frame', '5', 'length', 0.05)
    hold on
    trplot(R.A(1:4, q_0).T, 'frame', '4', 'length', 0.05)
